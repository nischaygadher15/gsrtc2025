...
const ViewTicket = () => {
  ...
  return (
    <div className="w-full h-full myContainer bg-[#f2f2f8] py-10 flex flex-col lg:flex-row gap-7">
      <div
        className="w-full lg:w-3/4 p-4 bg-white rounded-sm"
        style={{
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-[3fr_2fr_2fr_3fr] grid-rows-2 sm:grid-rows-1">
          <div className="order-1">
            <p className=" text-left p-1 text-sm text-[#1d1d1da3]">BOARDING</p>
          ...
          <div className="order-3 sm:order-1">
            ...
            <p className="p-1 font-semibold text-left sm:text-center">00:40</p>
          </div>
          ...
          <div className="order-2 sm:order-4">
            <p className="text-right p-1 text-sm text-[#1d1d1da3]">DROP OFF</p>
        ...
        <div className="border-t border-t-slate-200 pt-7 ">
          <p className="font-bold text-center text-[#1d1d1da3]">Fare Details</p>
          <table className="w-full">
            <tbody>
              <tr>
                <td className="w-[80%]">
              ...
              <tr className="">
                ...
                <td className="w-[20%] font-bold text-right">&#8377;729.00</td>
              </tr>
            </tbody>
          </table>
        </div>
